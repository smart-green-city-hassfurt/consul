    ...
    describe "search" do
      ...
      describe "on 'all' tab" do
        scenario "search by terms" do
          ...
          visit sdg_management_proposals_path(revision_status: "all")
          fill_in "search", with: "speech"
          click_button "Search"
        ...
        scenario "goal filter" do
          ...
          visit sdg_management_debates_path(revision_status: "all")
          select "4. Quality Education", from: "goal_code"
          click_button "Search"
        ...
        scenario "target filter" do
          ...
          visit sdg_management_legislation_processes_path(revision_status: "all")
      ...
      describe "on 'review' tab" do
        scenario "search by terms" do
          ...
          visit sdg_management_proposals_path(revision_status: "revised")
          fill_in "search", with: "speech"
          click_button "Search"
        ...
        scenario "goal filter" do
          ...
          visit sdg_management_debates_path(revision_status: "revised")
          select "4. Quality Education", from: "goal_code"
          click_button "Search"
        ...
        scenario "target filter" do
          ...
          visit sdg_management_legislation_processes_path(revision_status: "revised")
          select "5.1", from: "target_code"
          click_button "Search"
